...
class RepositoryAnalyzer:
    ...
    def get_repository_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'largest_repository': max(repositories, key=lambda x: x.get('size', 0))['name'] if repositories else None
        }
    ...
    def print_analysis_report(self) -> None:
        ...
        if stats:
            ...
            print(f"Public: {stats['public_repositories']} | Private: {stats['private_repositories']}")
            print(f"Total Stars: {stats['total_stars']} | Total Forks: {stats['total_forks']}")
            print(f"Most Recent: {stats['most_recently_updated']} (Updated: {stats['last_updated']})")
